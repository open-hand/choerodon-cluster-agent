...
import (
	...
	scheme "github.com/choerodon/choerodon-cluster-agent/pkg/apis/certificate/v1/client/clientset/versioned/scheme"
...
type CertificatesGetter interface {
	V1Certificates(namespace string) CertificateInterface
}
