...
import (
	v1alpha1 "github.com/choerodon/choerodon-cluster-agent/pkg/apis/certificate/v1alpha1/apis/certmanager/v1alpha1"
	"github.com/choerodon/choerodon-cluster-agent/pkg/apis/certificate/v1alpha1/client/clientset/versioned/scheme"
...
func (c *CertmanagerV1alpha1Client) V1alpha1Certificates(namespace string) CertificateInterface {
